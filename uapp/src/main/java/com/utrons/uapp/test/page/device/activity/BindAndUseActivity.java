package com.utrons.uapp.test.page.device.activity;
...
import com.utrons.uapp.test.page.device.bean.Device;
import com.utrons.uapp.test.page.device.bind.DeviceBindBusiness;
import com.utrons.uapp.test.page.device.bind.OnBindDeviceCompletedListener;
