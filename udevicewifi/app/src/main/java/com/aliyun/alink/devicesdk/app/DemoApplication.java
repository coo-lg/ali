...
public class DemoApplication extends Application {
    ...
    private void getDeviceInfoFrom(String testData) {
        ...
        try {
            ...
            if (checkValid(deviceInfoData.gateway)) {
                Log.d(TAG, "getDeviceInfoFrom: IoT base Version.");
                mDeviceInfoData = new DeviceInfoData();
                mDeviceInfoData.gateway = deviceInfoData.gateway;
                mDeviceInfoData.device = null;
                ...
                productKey = mDeviceInfoData.gateway.productKey;
                deviceName = mDeviceInfoData.gateway.deviceName;
                deviceSecret = mDeviceInfoData.gateway.deviceSecret;
                productSecret = mDeviceInfoData.gateway.productSecret;

                Log.d(TAG, "getDeviceInfoFrom: final data=" + mDeviceInfoData);
            } else if (checkValid(deviceInfoData.device)) {
                Log.d(TAG, "getDeviceInfoFrom: IoT advance Version.");
